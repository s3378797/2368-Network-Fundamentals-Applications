...
6. Quickly access one or two other computers using a command, now display the
MAC to IP address of those computers.
arp dstIPaddress

7. Show the MAC address of the host without using ipconfig.
netstat -i;

8. Show what shared resource are available on the 
host.
smbtree
